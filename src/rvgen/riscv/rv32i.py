...
def rv32i_beq(rs1: int, rs2: int, imm: int):
    return instruc_btype(RV32I_OPCODE_B, 0b000, rs1, rs2, imm)


def rv32i_bne(rs1: int, rs2: int, imm: int):
    return instruc_btype(RV32I_OPCODE_B, 0b001, rs1, rs2, imm)


def rv32i_blt(rs1: int, rs2: int, imm: int):
    return instruc_btype(RV32I_OPCODE_B, 0b100, rs1, rs2, imm)


def rv32i_bge(rs1: int, rs2: int, imm: int):
    return instruc_btype(RV32I_OPCODE_B, 0b101, rs1, rs2, imm)


def rv32i_bltu(rs1: int, rs2: int, imm: int):
    return instruc_btype(RV32I_OPCODE_B, 0b110, rs1, rs2, imm)


def rv32i_bgeu(rs1: int, rs2: int, imm: int):
    return instruc_btype(RV32I_OPCODE_B, 0b111, rs1, rs2, imm)


def rv32i_lb(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_L, rd, 0b000, rs1, imm)


def rv32i_lh(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_L, rd, 0b001, rs1, imm)


def rv32i_lw(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_L, rd, 0b010, rs1, imm)


def rv32i_lbu(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_L, rd, 0b100, rs1, imm)


def rv32i_lhu(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_L, rd, 0b101, rs1, imm)


def rv32i_sb(rs1: int, rs2: int, imm: int):
    return instruc_stype(RV32I_OPCODE_S, 0b000, rs1, rs2, imm)


def rv32i_sh(rs1: int, rs2: int, imm: int):
    return instruc_stype(RV32I_OPCODE_S, 0b001, rs1, rs2, imm)


def rv32i_sw(rs1: int, rs2: int, imm: int):
    return instruc_stype(RV32I_OPCODE_S, 0b010, rs1, rs2, imm)


def rv32i_addi(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b000, rs1, imm)


def rv32i_slti(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b010, rs1, imm)


def rv32i_sltiu(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b011, rs1, imm)


def rv32i_xori(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b100, rs1, imm)


def rv32i_ori(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b110, rs1, imm)


def rv32i_andi(rd: int, rs1: int, imm: int):
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b111, rs1, imm)


# Also works as the rv64i instruction of the same name (but with one more shamt bit)
def rv32i_slli(rd: int, rs1: int, shamt: int):
    imm = shamt
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b001, rs1, imm)


# Also works as the rv64i instruction of the same name (but with one more shamt bit)
def rv32i_srli(rd: int, rs1: int, shamt: int):
    imm = shamt
    return instruc_itype(RV32I_OPCODE_ALU_IMM, rd, 0b101, rs1, imm)
...
def rv32i_add(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b000, rs1, rs2, 0b0000000)


def rv32i_sub(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b000, rs1, rs2, 0b0100000)


def rv32i_sll(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b001, rs1, rs2, 0b0000000)


def rv32i_slt(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b010, rs1, rs2, 0b0000000)


def rv32i_sltu(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b011, rs1, rs2, 0b0000000)


def rv32i_xor(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b100, rs1, rs2, 0b0000000)


def rv32i_srl(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b101, rs1, rs2, 0b0000000)


def rv32i_sra(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b101, rs1, rs2, 0b0100000)


def rv32i_or(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b110, rs1, rs2, 0b0000000)


def rv32i_and(rd: int, rs1: int, rs2: int):
    return instruc_rtype(RV32I_OPCODE_ALU_REG, rd, 0b111, rs1, rs2, 0b0000000)


# @param imm is fm, pred and succ.
def rv32i_fence(imm: int):
    return instruc_itype(RV32I_OPCODE_FEN, 0b0, 0b000, 0b0, imm)


def rv32i_ecall():
    return instruc_itype(RV32I_OPCODE_E, 0, 0b000, 0, 0)


def rv32i_ebreak():
    return instruc_itype(RV32I_OPCODE_E, 0, 0b000, 0, 1)
