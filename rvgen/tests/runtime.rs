...
fn executable_entry_mailboxes_and_symbols() {
    for (is_64bit, expected) in [
        (false, include_bytes!("fixtures/runtime32.bin").as_slice()),
        (true, include_bytes!("fixtures/runtime64.bin").as_slice()),
    ] {
